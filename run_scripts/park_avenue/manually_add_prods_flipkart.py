...
collec = client["flipkart_marketplace_scraping_park_avenue"]["product_list"]

prods_df = pd.read_csv("Park_Avenue_Flipkart_Amazon_Match.csv")
...
prods_df[
    "static"
] = "https://www.flipkart.com/park-avenue-good-morning-freshness-body-spray-men/p/itm8f47acec1c6db"
products = []

# prods_df.to_csv('Park_Avenue_Flipkart_Amazon_Match.csv', index=False)
