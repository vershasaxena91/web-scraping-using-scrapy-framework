...
collec = client["amazon_marketplace_scraping_nature_essence"]["product_list"]

prods_df = pd.read_csv("Nature_Essence_Flipkart_Amazon_Match.csv")
...
for product in products:
    ...
    client_added = collec.find_one(
        {"product_asin": product["product_asin"], "clients": "Nature_Essence"}
    )
    if not client_added:
        collec.find_one_and_update(
