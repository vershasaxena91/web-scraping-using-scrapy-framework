...
collec = client["flipkart_marketplace_scraping_havells"]["product_list"]

prods_df = pd.read_csv("Havells_Flipkart_Amazon_Match.csv")
...
# prods_df.to_csv('Havells_Flipkart_Amazon_Match.csv', index=False)
