...
collec = client["amazon_marketplace_scraping_lloyd_washing_machine"]["product_list"]

prods_df = pd.read_csv("Amazon_Lloyd_Washing_Machine.csv")
...
for product in products:
    ...
    client_added = collec.find_one(
        {"product_asin": product["product_asin"], "clients": "Lloyd_Washing_Machine"}
    )
    if not client_added:
        collec.find_one_and_update(
