...
class Converter:
    ...
    def convert_doc(self, i):
        ...
        idx = pd.period_range("11-07-2022", "11-11-2022")
...
if __name__ == "__main__":
    ...
    cvt = Converter(
        ...
        "../../sentiment_analysis/XGBoost_Model_Powder.json",
    )
    cvt.convert()
    cvt.save(
        "../../data/OutputData/nycil_powder/flipkart_marketplace_scraping_new/flipkart_prod_info.csv",
        "../../data/OutputData/nycil_powder/flipkart_marketplace_scraping_new/flipkart_prod_move.csv",
    )
